...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter  {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				.antMatchers(HttpMethod.GET, "/v1/produto/{id:[0-9]+}").permitAll()
				.antMatchers(HttpMethod.POST, "/v1/usuario").permitAll()
				.antMatchers(HttpMethod.POST, "/v1/notafiscal").permitAll()
				.antMatchers(HttpMethod.POST, "/v1/ranking").permitAll()
